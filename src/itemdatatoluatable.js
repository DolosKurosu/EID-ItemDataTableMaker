...
let pools = XmlParser_1.XmlParser.loadPools(
	fs.readFileSync("assets/itempools.xml", "utf8")
);
let meta = XmlParser_1.XmlParser.loadMeta(
	fs.readFileSync("assets/items_metadata.xml", "utf8")
);
